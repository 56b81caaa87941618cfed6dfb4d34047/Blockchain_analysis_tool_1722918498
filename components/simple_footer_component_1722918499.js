...
*/
Vue.component("simple_footer_component_1722918499", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-6 text-3xl font-bold text-white hover:text-pink-200 transition duration-300">
                            ...
                            BlockScan - Blockchain Analytics Suite
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-white opacity-80 hover:opacity-100 transition duration-300">
                        Stay ahead of the curve with BlockScan's cutting-edge blockchain data analysis tools. Gain real-time insights and make informed decisions for your decentralized projects. Powered by a robust and scalable infrastructure, BlockScan ensures you never miss a beat in the dynamic world of blockchain.
                    </div>
                </div>
            </div>
        </footer> 
